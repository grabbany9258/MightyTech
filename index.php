...
<div class="container-fluid remove-vid-marg">
  ...
  <div class="vid-content">
    <h1 class="my-content">Welcome to The <span style="color: #41bcfb;">Mighty-Tech</span> BD</h1>
...
<div class="container-fluid bg-danger txt-banner"> <!-- Start Text Banner -->
  <div class="row bottom-banner">
    ...
    <div class="col-sm">
      <h5><img src="image/dl.png" alt="" style="width: 20px; height: 25px;"> Money Back Guarantee*</h5>
    </div>
  </div>
</div> <!-- End Text Banner -->
...
<div class="container mt-5"> <!-- Start Most Popular Course -->
  ...
  <div class="text-center m-2 mt-4">
    <a class="btn btn-danger btn-lg" href="courses.php">View All Course</a>
  </div>
